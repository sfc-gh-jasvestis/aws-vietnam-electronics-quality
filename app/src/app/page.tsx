  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="First Pass Yield" value={kpiVal('First Pass Yield', '98.4%')} status="neutral" />
        <KPICard title="Customer Returns" value={kpiVal('Customer Returns', '0.08%')} status="neutral" />
        <KPICard title="Quality Escapes" value={kpiVal('Quality Escapes', '2')} status="danger" />
        <KPICard title="Inspections (MTD)" value={kpiVal('Inspections (MTD)', '4.2M')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="DPMO" value={kpiVal('DPMO', '124')} />
        <KPICard title="Rework Rate" value={kpiVal('Rework Rate', '1.2%')} />
        <KPICard title="AOI Detection" value={kpiVal('AOI Detection', '99.4%')} />
      </div>
      <Chart
